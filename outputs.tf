...
output "spot_instance_request_id" {
  description = "The request ID for spot instances"
  value = try(
    aws_instance.this[0].spot_instance_request_id,
    aws_instance.ignore_ami[0].spot_instance_request_id,
    null,
  )
}

output "instance_lifecycle" {
  description = "The instance lifecycle type, it's either a scheduled instance or spot instance"
  value = try(
    aws_instance.this[0].instance_lifecycle,
    aws_instance.ignore_ami[0].instance_lifecycle,
    null,
  )
}
